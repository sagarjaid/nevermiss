  ...
  return (
    <>
      {pathName.endsWith('/') ? (
        ...
        <button
          className='btn bg-green-300 hover:bg-green-400 disabled:bg-green-400 disabled:text-black rounded-sm text-black btn-block group'
