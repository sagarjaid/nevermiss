        ...
        <div className='relative flex justify-center flex-col lg:flex-row items-center lg:items-stretch gap-8'>
          {config.stripe.plans.map((plan) => (
            <div
              ...
              {plan.isFeatured && (
                <div className='absolute top-0 left-16 -translate-x-1/2 -translate-y-1/2 z-20'>
                  <span
                    className={`badge text-xs text-primary-content font-semibold border-0 bg-green-500`}>
                    POPULAR
                  </span>
                </div>
              )}
